//URLs
export const BASE_URL = process.env.REACT_APP_BASEURL !== undefined ? process.env.REACT_APP_BASEURL : 'http://127.0.0.1:5000/'
...
export const GET_NOTIFICATIONS_URL = BASE_URL + 'acfiiinnoostt / listen_nots / open_price'
